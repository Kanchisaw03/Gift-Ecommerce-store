              ...
              <div>
                <div className="bg-black/30 border border-gold/20 h-64 overflow-hidden">
                  <img 
                    ...
                    onError={(e) => {
                      e.target.src = "data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300' preserveAspectRatio='none'%3E%3Cg%3E%3Ctext style='font-family:Arial;font-size:20px;font-weight:bold;dominant-baseline:middle;text-anchor:middle;fill:rgba(100,100,100,0.8)' x='50%25' y='50%25'%3EProduct%3C/text%3E%3C/g%3E%3C/svg%3E";
                    }}
                  />
                </div>
              </div>
