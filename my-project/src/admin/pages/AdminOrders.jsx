...
const AdminOrders = () => {
  const { orders, fetchOrders, updateOrderStatus, loading: contextLoading } = useAdmin();
  ...
  useEffect(() => {
    const loadOrders = async () => {
      ...
      try {
        ...
        console.log('AdminOrders: Attempting to fetch orders with filters');
        ...
        try {
          ...
          try {
            const altResponse = await axiosInstance.get('/admin/orders/debug');
            ...
            try {
              const altResponse2 = await axiosInstance.get('/admin/debug');
              console.log('Admin debug endpoint response:', altResponse2.data);
            } catch (debugError2) {
          ...
          {loading || contextLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-400 max-w-md mx-auto">
                {searchTerm ? 'Try adjusting your search or filter criteria.' : 'There are no orders in the system yet.'}
              </p>
            </div>
          ) : (
